        ...
        <form id="searchForm">
            <table id="buttons">
                <tr>
                    ...
                    <td width="230px">
                        <select name='status' style="width:200px" id='status' class="easyui-combobox">
                    ...
                    <td width="230px">
                        <select name='source' style="width:200px" id='source' class="easyui-combobox">
                            <option value="">全部</option>
                ...
                <tr>
                    ...
                    <td width="230px">
                        <select name='companyId' id='c_company_id' validType="checkName" style="width: 200px"
                                class="easyui-validatebox"> </select>
                    </td>
                    <td width="100px" style="text-align:right;">纳税人标识：</td>
                    <td width="230px">
                        <select name='type' style="width:200px" id='type' class="easyui-combobox">
                            <option value="">全部</option>
                ...
                <tr>
                    ...
                    <td width="230px">
                        <input name="dateRangStart" id="dateRangStart" type="text" size="10"/>至
                        <input name="dateRangEnd" type="text" id="dateRangEnd" size="10"/>
                    </td>
                ...
                <tr>
                    <td width="300px" style="text-align: center;width: 300px" colspan="2">
                        <input type="button" class="easyui-button width_80 l-btn l-btn-small"
                               value="查询" onclick="search();"/>
                        <input type="button" class="easyui-button width_80 l-btn l-btn-small" style="margin-left:10px"
                               value="审核通过" onclick="pass();"/>
                        <input type="button" class="easyui-button width_80 l-btn l-btn-small" style="margin-left:10px"
                               value="不通过" onclick="unpass();"/>
                        <input type="button" class="easyui-button width_80 l-btn l-btn-small" style="margin-left:10px"
                               value="导出" onclick="exportList();"/>
                    </td>
                </tr>
            </table>
        </form>
    </div>
    <div id="cardAudit_query_div" style="width: 100%; position: absolute; top: 135px ; left: 0 ; bottom: 0;">
