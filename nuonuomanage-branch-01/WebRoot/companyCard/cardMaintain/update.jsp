    ...
    <form id="cmpMaintain_edit_form" method="post">
        <table style="padding:10px 0 0 0;width:98%;font-size: 12px;margin: 0 auto;">
            <tr>
                ...
                <th>开票信息来源:</th>
                <td>
                    <select name='source' class="easyui-combobox" style="width:200px" data-options="panelHeight:'auto'">
                        <c:choose>
                            ...
                            <c:when test="${card.source == 33}">
                                ...
                                <option value="31">微信未登录</option>
                                <option value="32">微信已登录</option>
                                <option value="33" selected="selected">工商信息</option>
                                <option value="40">用户中心</option>
                                <option value="50">请求开票</option>
                                <option value="99">ADMIN</option>
                                <option value="">未知</option>
            ...
            <tr>
                ...
                <th>纳税人标识:</th>
                <td>
                    <select name='type' class="easyui-combobox" style="width:200px" data-options="panelHeight:'auto'">
                        <c:choose>
            ...
            <tr>
                ...
                <td>
                    ${card.code}
                    <input type="hidden" name="code" value="${card.code}" id="code" style="width:195px"/>
                </td>
                <th>认证标识:</th>
                <td>
                    <select name='cert' class="easyui-combobox" style="width:200px" data-options="panelHeight:'auto'">
                        <c:choose>
            ...
            <tr>
                <th>地址:</th>
                <td>
                    <input type="text" name="address" value="${card.address}" class='easyui-validatebox' style="width:195px"
                           data-options="required:true,missingMessage:'地址不能为空'" validType="length[3,60]"/>
                </td>
                <th>电话:</th>
                <td>
                    <input type="text" name="telephone" value="${card.telephone}" class='easyui-validatebox' style="width:195px"
            ...
            <tr>
                <th>开户行:</th>
                <td>
                    <input type="text" name="bank" value="${card.bank}" class='easyui-validatebox' style="width:195px"
                           validType="length[2,40]"/>
                </td>
                <th>银行账号</th>
                <td>
                    <input type="text" name="account" value="${card.account}" class='easyui-validatebox' style="width:195px"
                           validType="length[9,25]"/>
                </td>
            </tr>
            <tr>
                <th>数据状态:</th>
                <td>
                    <select name='status' class="easyui-combobox" style="width:200px" data-options="panelHeight:'auto'">
                        <c:choose>
