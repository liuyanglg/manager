...
public class KPAssignCodeVO {
    ...
    private String timeType;//创建、修改、绑定时间
    private String dateRangStart;	//开始日期
    private String dateRangEnd;//结束日期

    private String assignCmpNameOrTaxid;
    private String bindCmpNameOrTaxid;
    ...
    public String toString() {
        return "KPAssignCodeVO{" +
                ...
                ", timeType='" + timeType + '\'' +
                ", dateRangStart='" + dateRangStart + '\'' +
                ", dateRangEnd='" + dateRangEnd + '\'' +
                ", assignCmpNameOrTaxid='" + assignCmpNameOrTaxid + '\'' +
                ", bindCmpNameOrTaxid='" + bindCmpNameOrTaxid + '\'' +
                '}';
    }
}
