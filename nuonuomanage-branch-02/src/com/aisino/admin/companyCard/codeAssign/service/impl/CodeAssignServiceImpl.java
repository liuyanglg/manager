...
public class CodeAssignServiceImpl implements CodeAssignService {
    ...
    public List<KPAssignCodeVO> fuzzyQueryPage(Page<KPAssignCodeVO> page) {
        return codeAssignDao.fuzzyQueryPage(page);
    }

    public int fuzzyCount(Page<KPAssignCodeVO> page) {
        return codeAssignDao.fuzzyCount(page);
    }
